...
class CIFAR10Dataset(data.Dataset):
    ...
    def __init__(self, config, mode):
        ...
        torch.save(np.shape(self.data[0]), 'self.sample_shp')
    ...
    def __getitem__(self, index):
        ...
        data_cur = torch.from_numpy(item)
		
        # Not sure what to assign to label_cur yet
